...
export function FeatureTwo() {
  return (
    <div className=" bg-blue-gray-100 maxw-19xl lg:px-8">
      <div className="grid grid-cols-1 gap-y-8 text-center px-10 py-10 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
        <div>
