            ...
            <div className="lg:col-span-2">
              <div className="flex flex-row justify-between space-x-4">
                ...
                <div className="flex-1">
                  <Statscard bgImage={bgImage1} percentage="24" statsName="Revenue" value="$12,000"
                             icon={CurrencyDollarIcon} color="#6A5FFF"/>
                </div>
                <div className="flex-1">
                  <Statscard bgImage={bgImage2} percentage="18" statsName="Profit" value="$2,000" icon={CheckCircleIcon}
                             color="#07B3EE"/>
                </div>
                <div className="flex-1">
                  <Statscard bgImage={bgImage3} percentage="10" statsName="EBIDTA" value="20%" icon={ChartBarIcon}
                             color="#FF888A"/>
                </div>
                <div className="flex-1">
                  <Statscard bgImage={bgImage4} percentage="08" statsName="Gross Margin" value="40%"
                             icon={Square3Stack3DIcon} color="#5182FE"/>
                </div>
              </div>
