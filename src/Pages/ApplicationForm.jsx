...
const ApplicationForm = () => {
    ...
    const handleSubmit1 = async (e) => {
        ...
        try {
            ...
            const plotResponse = await fetch('http://127.0.0.1:5002/plot_pnl', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleSubmit2 = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://127.0.0.1:5002/calculate_returns", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleSubmit4 = async (e) => {
        ...
        for (const shareholder of equityDistribution.shareholders) {
            await axios.post("http://127.0.0.1:5002/add-shareholder", {
        ...
        await axios.post("http://127.0.0.1:5002/simulate-funding", {
        ...
        const response = await axios.get("http://127.0.0.1:5002/get-cap-table");
    ...
    const calculateValuation = async () => {
        try {
            const response = await axios.post("http://127.0.0.1:5002/calculate_valuation", valuationInputs);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://127.0.0.1:5002/calculate-equity', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
